describe('Controller: PackageFilterController', function() {
    ...
    it("can show matching content", function () {
        ...
        expect(result.templateUrl).toContain('content-views/details/filters/views/filter-rule-matching-content-modal.html');
        expect(result.controller).toBe('FilterRuleMatchingContentModal');
    });
});
